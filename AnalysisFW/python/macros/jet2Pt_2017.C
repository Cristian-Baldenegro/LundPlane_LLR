...
TH1F *h=(TH1F*)f->Get("jet2Pt");
TH1F *h2=(TH1F*)f2->Get("jet2Pt");
TH1F *h3=(TH1F*)f3->Get("jet2Pt");
TH1F *h4=(TH1F*)f4->Get("jet2Pt");
...
//   h7->Draw("pe hist same");
   ...
   h->GetXaxis()->SetTitle("p_{T}^{jet2} [GeV]");

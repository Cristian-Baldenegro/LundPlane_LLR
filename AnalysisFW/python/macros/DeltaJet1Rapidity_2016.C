...
TH1F *h2=(TH1F*)f2->Get("DeltaJet1Rapidity");
TH1F *h3=(TH1F*)f3->Get("DeltaJet1Rapidity");
TH1F *h4=(TH1F*)f4->Get("DeltaJet1Rapidity");
...
//   h7->Draw("pe hist same");
   ...
   h2->GetXaxis()->SetTitle("y^{jet1,gen} - y^{jet1,det}");
...
//   c1->Draw("same");
   c1->SaveAs("DeltaJet1Rapidity_2016.png");

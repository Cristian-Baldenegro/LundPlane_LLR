...
TH1F *h=(TH1F*)f->Get("jet2Rapidity");
TH1F *h2=(TH1F*)f2->Get("jet2Rapidity");
TH1F *h3=(TH1F*)f3->Get("jet2Rapidity");
TH1F *h4=(TH1F*)f4->Get("jet2Rapidity");
...
//   c1->Draw("same");
   c1->SaveAs("jet2Rapidity2016.png");

...
TH1F *h2=(TH1F*)f2->Get("DeltaJet2Phi");
TH1F *h3=(TH1F*)f3->Get("DeltaJet2Phi");
TH1F *h4=(TH1F*)f4->Get("DeltaJet2Phi");
...
//   h7->Draw("pe hist same");
   ...
   h2->GetXaxis()->SetTitle("#phi^{jet2,gen} - #phi^{jet2,det}");
...
//   c1->Draw("same");
   c1->SaveAs("DeltaJet2Phi_2016.png");

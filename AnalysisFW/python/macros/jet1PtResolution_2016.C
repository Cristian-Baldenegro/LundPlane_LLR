...
TH1F *h2=(TH1F*)f2->Get("jet1PtResolution");
TH1F *h3=(TH1F*)f3->Get("jet1PtResolution");
TH1F *h4=(TH1F*)f4->Get("jet1PtResolution");
...
//   h7->Draw("pe hist same");
   ...
   h2->GetXaxis()->SetTitle("(p_{T}^{jet1,gen} - p_{T}^{jet1,det})/p_{T}^{jet1,gen}");
...
//   c1->Draw("same");
   c1->SaveAs("jet1PtResolution_2016.png");

...
TH1F *h=(TH1F*)f->Get("DeltaRapidity");
TH1F *h2=(TH1F*)f2->Get("DeltaRapidity");
TH1F *h3=(TH1F*)f3->Get("DeltaRapidity");
TH1F *h4=(TH1F*)f4->Get("DeltaRapidity");
...
//   h7->Draw("pe hist same");
   ...
   h->GetXaxis()->SetTitle("|y_{jet1} - y_{jet2}|");
...
//   c1->Draw("same");
   c1->SaveAs("DeltaRapidity2016.png");

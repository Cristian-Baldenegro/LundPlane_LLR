...
lumi->DrawLatex(0.7, 0.92, "#bf{13 TeV (2017)}");
lumi->Draw();
...
prelim->DrawLatex(0.55, 0.75, "#bf{p_{T}^{jet1} > 550 GeV, p_{T}^{jet2} > 500 GeV }");
//prelim->DrawLatex(0.175, 0.35, "#bf{p_{T}^{j1,j2} > 40 GeV}");
prelim->DrawLatex(0.55, 0.7, "#bf{|y_{jet1}|, |y_{jet2}| < 2}");
prelim->DrawLatex(0.55, 0.85, "#bf{PUPPI AK4 jets}");
prelim->Draw();
}
...
TFile *f = new TFile("output_data_ak417.root");
TFile *f2 = new TFile("output_mc_ak417hw.root");
TFile *f3 = new TFile("output_mc_ak417py.root");
TFile *f4 = new TFile("output_mc_ak417mg.root");

TH1F *h=(TH1F*)f->Get("jetPtAsymmetry");
TH1F *h2=(TH1F*)f2->Get("jetPtAsymmetry");
TH1F *h3=(TH1F*)f3->Get("jetPtAsymmetry");
TH1F *h4=(TH1F*)f4->Get("jetPtAsymmetry");
...
//   h->GetYaxis()->SetRangeUser(0.000,0.3);
...
//   h7->Draw("pe hist same");
   ...
   h->GetYaxis()->SetTitle("normalized to integral");
   ...
   h->GetXaxis()->SetTitle("(p_{T}^{jet1}-p_{T}^{jet2})/(p_{T}^{jet1}+p_{T}^{jet2})");
...
//   c1->Draw("same");
   c1->SaveAs("jetPtAsymmetry2017.png");

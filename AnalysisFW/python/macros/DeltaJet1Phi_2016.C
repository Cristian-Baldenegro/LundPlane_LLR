...
TH1F *h2=(TH1F*)f2->Get("DeltaJet1Phi");
TH1F *h3=(TH1F*)f3->Get("DeltaJet1Phi");
TH1F *h4=(TH1F*)f4->Get("DeltaJet1Phi");
...
//   h7->Draw("pe hist same");
   ...
   h2->GetXaxis()->SetTitle("#phi^{jet1,gen} - #phi^{jet1,det}");
...
//   c1->Draw("same");
   c1->SaveAs("DeltaJet1Phi_2016.png");

...
// Tue Nov 16 22:11:03 2021 by ROOT version 6.21/01
// from TTree ProcessedTree/ProcessedTree
// found on file: data_ak416.root
//////////////////////////////////////////////////////////

#ifndef ProcessedTree_data_h
#define ProcessedTree_data_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxPFJetsCHS_ = 20;
   static constexpr Int_t kMaxPFJetsCHS__genIdx = 20;
   static constexpr Int_t kMaxPFJetsCHS__genR = 20;
   static constexpr Int_t kMaxPFJetsCHS__cor = 20;
   static constexpr Int_t kMaxPFJetsCHS__jecLabels = 20;
   static constexpr Int_t kMaxPFJetsCHS__unc = 20;
   static constexpr Int_t kMaxPFJetsCHS__uncSrc = 20;
   static constexpr Int_t kMaxPFJetsCHS__area = 20;
   static constexpr Int_t kMaxPFJetsCHS__looseID = 20;
   static constexpr Int_t kMaxPFJetsCHS__tightID = 20;
   static constexpr Int_t kMaxPFJetsCHS__pfCombinedCvsL = 20;
   static constexpr Int_t kMaxPFJetsCHS__pfCombinedCvsB = 20;
   static constexpr Int_t kMaxPFJetsCHS__pfDeepCSVb = 20;
   static constexpr Int_t kMaxPFJetsCHS__pfDeepCSVc = 20;
   static constexpr Int_t kMaxPFJetsCHS__pfDeepCSVl = 20;
   static constexpr Int_t kMaxPFJetsCHS__pfDeepCSVbb = 20;
   static constexpr Int_t kMaxPFJetsCHS__pfBTag_JetProb = 20;
   static constexpr Int_t kMaxPFJetsCHS__pfBTag_CombInclSecVtxV2 = 20;
   static constexpr Int_t kMaxPFJetsCHS__pfBTag_CombMVAV2 = 20;
   static constexpr Int_t kMaxPFJetsCHS__QGL = 20;
   static constexpr Int_t kMaxPFJetsCHS__QGAx2 = 20;
   static constexpr Int_t kMaxPFJetsCHS__QGMul = 20;
   static constexpr Int_t kMaxPFJetsCHS__QGPtD = 20;
   static constexpr Int_t kMaxPFJetsCHS__partonFlavour = 20;
   static constexpr Int_t kMaxPFJetsCHS__partonFlavourPhysicsDef = 20;
   static constexpr Int_t kMaxPFJetsCHS__hadronFlavour = 20;
   static constexpr Int_t kMaxPFJetsCHS__LHA = 20;
   static constexpr Int_t kMaxPFJetsCHS__Width = 20;
   static constexpr Int_t kMaxPFJetsCHS__Thrust = 20;
   static constexpr Int_t kMaxPFJetsCHS__PtD = 20;
   static constexpr Int_t kMaxPFJetsCHS__Mult = 20;
   static constexpr Int_t kMaxPFJetsCHS__chf = 20;
   static constexpr Int_t kMaxPFJetsCHS__nhf = 20;
   static constexpr Int_t kMaxPFJetsCHS__nemf = 20;
   static constexpr Int_t kMaxPFJetsCHS__cemf = 20;
   static constexpr Int_t kMaxPFJetsCHS__muf = 20;
   static constexpr Int_t kMaxPFJetsCHS__hf_hf = 20;
   static constexpr Int_t kMaxPFJetsCHS__hf_phf = 20;
   static constexpr Int_t kMaxPFJetsCHS__hf_hm = 20;
   static constexpr Int_t kMaxPFJetsCHS__hf_phm = 20;
   static constexpr Int_t kMaxPFJetsCHS__chm = 20;
   static constexpr Int_t kMaxPFJetsCHS__nhm = 20;
   static constexpr Int_t kMaxPFJetsCHS__phm = 20;
   static constexpr Int_t kMaxPFJetsCHS__elm = 20;
   static constexpr Int_t kMaxPFJetsCHS__mum = 20;
   static constexpr Int_t kMaxPFJetsCHS__ncand = 20;
   static constexpr Int_t kMaxPFJetsCHS__cm = 20;
   static constexpr Int_t kMaxPFJetsCHS__betaPrime = 20;
   static constexpr Int_t kMaxPFJetsCHS__mpuTrk = 20;
   static constexpr Int_t kMaxPFJetsCHS__mlvTrk = 20;
   static constexpr Int_t kMaxPFJetsCHS__mjtTrk = 20;
   static constexpr Int_t kMaxPFJetsCHS__hof = 20;
   static constexpr Int_t kMaxPFJetsCHS__lha = 20;
   static constexpr Int_t kMaxPFJetsCHS__width = 20;
   static constexpr Int_t kMaxPFJetsCHS__thrust = 20;
   static constexpr Int_t kMaxPFJetsCHS__pujid = 20;
 ...
 //vector<vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<double> > > > L1Obj_;
   ...
   Float_t         PFJetsCHS__LHA_[kMaxPFJetsCHS_];   //[PFJetsCHS__]
   Float_t         PFJetsCHS__Width_[kMaxPFJetsCHS_];   //[PFJetsCHS__]
   Float_t         PFJetsCHS__Thrust_[kMaxPFJetsCHS_];   //[PFJetsCHS__]
   Float_t         PFJetsCHS__PtD_[kMaxPFJetsCHS_];   //[PFJetsCHS__]
   Int_t           PFJetsCHS__Mult_[kMaxPFJetsCHS_];   //[PFJetsCHS__]
   ...
   TBranch        *b_PFJetsCHS__LHA_;   //!
   TBranch        *b_PFJetsCHS__Width_;   //!
   TBranch        *b_PFJetsCHS__Thrust_;   //!
   TBranch        *b_PFJetsCHS__PtD_;   //!
   TBranch        *b_PFJetsCHS__Mult_;   //!
   ...
   ProcessedTree_data(TTree *tree=0);
   virtual ~ProcessedTree_data();
...
#ifdef ProcessedTree_data_cxx
ProcessedTree_data::ProcessedTree_data(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("data_ak417.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("data_ak417.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("data_ak417.root:/ak4");
...
ProcessedTree_data::~ProcessedTree_data()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t ProcessedTree_data::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ProcessedTree_data::LoadTree(Long64_t entry)
{
...
void ProcessedTree_data::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("PFJetsCHS_.LHA_", PFJetsCHS__LHA_, &b_PFJetsCHS__LHA_);
   fChain->SetBranchAddress("PFJetsCHS_.Width_", PFJetsCHS__Width_, &b_PFJetsCHS__Width_);
   fChain->SetBranchAddress("PFJetsCHS_.Thrust_", PFJetsCHS__Thrust_, &b_PFJetsCHS__Thrust_);
   fChain->SetBranchAddress("PFJetsCHS_.PtD_", PFJetsCHS__PtD_, &b_PFJetsCHS__PtD_);
   fChain->SetBranchAddress("PFJetsCHS_.Mult_", PFJetsCHS__Mult_, &b_PFJetsCHS__Mult_);
...
Bool_t ProcessedTree_data::Notify()
{
...
void ProcessedTree_data::Show(Long64_t entry)
{
...
Int_t ProcessedTree_data::Cut(Long64_t entry)
{
...
#endif // #ifdef ProcessedTree_data_cxx

...
TH1F *h=(TH1F*)f->Get("multiplicity");
TH1F *h2=(TH1F*)f2->Get("multiplicity");
TH1F *h3=(TH1F*)f3->Get("multiplicity");
TH1F *h4=(TH1F*)f4->Get("multiplicity");
...
//   h7->Draw("pe hist same");
   ...
   h->GetXaxis()->SetTitle("n_{charged}+n_{neutral}");
...
//   c1->Draw("same");
   c1->SaveAs("multiplicity2016.png");

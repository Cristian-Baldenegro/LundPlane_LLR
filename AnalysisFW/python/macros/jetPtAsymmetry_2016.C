...
lumi->DrawLatex(0.7, 0.92, "#bf{13 TeV (2016)}");
lumi->Draw();
...
TFile *f = new TFile("output_data_ak416.root");
TFile *f2 = new TFile("output_mc_ak416hw.root");
TFile *f3 = new TFile("output_mc_ak416py.root");
TFile *f4 = new TFile("output_mc_ak416mg.root");
...
//   c1->Draw("same");
   c1->SaveAs("jetPtAsymmetry2016.png");

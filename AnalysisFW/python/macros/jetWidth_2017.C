...
TH1F *h=(TH1F*)f->Get("jetWidth");
TH1F *h2=(TH1F*)f2->Get("jetWidth");
TH1F *h3=(TH1F*)f3->Get("jetWidth");
TH1F *h4=(TH1F*)f4->Get("jetWidth");
...
//   h7->Draw("pe hist same");
   ...
   h->GetXaxis()->SetTitle("Width (girth)");

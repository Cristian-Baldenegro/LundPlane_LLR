...
TH1F *h=(TH1F*)f->Get("jet1Pt");
TH1F *h2=(TH1F*)f2->Get("jet1Pt");
TH1F *h3=(TH1F*)f3->Get("jet1Pt");
TH1F *h4=(TH1F*)f4->Get("jet1Pt");
...
*/
   ...
   h->Rebin(4); h2->Rebin(4); h3->Rebin(4); h4->Rebin(4);
   h->GetYaxis()->SetRangeUser(0.000,0.5);
...
//   h7->Draw("pe hist same");
   ...
   h->GetXaxis()->SetTitle("p_{T}^{jet1} [GeV]");

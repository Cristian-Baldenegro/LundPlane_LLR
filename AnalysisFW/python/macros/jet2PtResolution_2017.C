...
TH1F *h2=(TH1F*)f2->Get("jet2PtResolution");
TH1F *h3=(TH1F*)f3->Get("jet2PtResolution");
TH1F *h4=(TH1F*)f4->Get("jet2PtResolution");
...
//   h7->Draw("pe hist same");
   ...
   h2->GetXaxis()->SetTitle("(p_{T}^{jet2,gen} - p_{T}^{jet2,det})/p_{T}^{jet2,gen}");
...
//   c1->Draw("same");
   c1->SaveAs("jet2PtResolution_2017.png");

...
// Wed Nov 17 11:17:17 2021 by ROOT version 6.14/09
// from TTree ProcessedTree/ProcessedTree
// found on file: mc_ak416py_pThat470to600.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxGenJets_ = 18;
 ...
 //QCDEvent        *events;
   ...
   TBranch        *b_events_HLTObj_;   //!
   TBranch        *b_events_L1Obj_;   //!
...
ProcessedTree::ProcessedTree(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("mc_ak416hw.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("mc_ak416hw.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("mc_ak416hw.root:/ak4");
...
Int_t ProcessedTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ProcessedTree::LoadTree(Long64_t entry)
{
...
void ProcessedTree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("HLTObj_", &HLTObj_, &b_events_HLTObj_);
   fChain->SetBranchAddress("L1Obj_", &L1Obj_, &b_events_L1Obj_);
...
void ProcessedTree::Show(Long64_t entry)
{
...
Int_t ProcessedTree::Cut(Long64_t entry)
{

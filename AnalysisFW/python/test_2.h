...
// Thu Dec  9 12:04:07 2021 by ROOT version 6.14/09
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("DATA_MG8_1GeV_1GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("DATA_MG8_1GeV_1GeV.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("DATA_MG8_1GeV_1GeV.root:/ak4");
